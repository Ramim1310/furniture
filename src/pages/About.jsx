      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4 leading-relaxed">
              হামযা ফার্নিচার হাউস একটি পারিবারিক উদ্যোগ যা সততা এবং গুণগত মানের উপর ভিত্তি করে প্রতিষ্ঠিত। আমাদের মূল লক্ষ্য হলো বাংলাদেশের প্রতিটি
              ঘরে সাশ্রয়ী মূল্যে বিশ্বমানের আসবাবপত্র পৌঁছে দেওয়া।
            </p>
            <p className="text-slate-600 leading-relaxed">
              আমরা বিশ্বাস করি আসবাবপত্র কেবল একটি বস্তু নয়, এটি আপনার রুচি এবং ব্যক্তিত্বের প্রতিচ্ছবি। তাই আমরা প্রতিটি পণ্য তৈরিতে সর্বোচ্চ
              সতর্কতা এবং যত্ন অবলম্বন করি।
            </p>
          </div>
        </div>
        ...
        <div className="bg-indigo-700 rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 text-lg font-medium">
            <span>📞 +8801794-300330 </span>
            <span>📍 রুয়েট গেট, তালাইমারী, রাজশাহী</span>
